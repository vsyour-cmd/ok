...
# 仅创建桌面用户，不在这里设置密码 (防止 docker history 泄露)
...
CONTAINER_ID=$(docker run -d \
  ...
  -v "$PWD/share_box:/home/$RDP_USER/Desktop/share_box" \
